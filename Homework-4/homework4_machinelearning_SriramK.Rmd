...
On average we use 9.748% of the observations are utilized as over 90 or below 10 of the given domain [0,1], we lose values on the right hand side of X or left hand side of X respectively due to 1 and 0 being hard limits. 
