...
In case of the linear model using mixture data, we see that our model has a high bias due to a large number of orange points and blue points being predicted wrongly. 
